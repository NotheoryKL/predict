...
class Stocker():
    ...
    def changepoint_prior_analysis(self, changepoint_priors=[0.001, 0.05, 0.1, 0.2], colors=['b', 'r', 'grey', 'gold']):
        ...
        plt.xlabel('100     101     102     103     104     105     106     107     108     109     110           predict        ',fontsize=10); 
        plt.ylabel('Employee'); 
    ...
    def predict_future(self, days=30):
        ...
        plt.ylabel('Employee');
        plt.xlabel('An error bar = one month'); plt.title('Predicted The Trend Of Employee');
